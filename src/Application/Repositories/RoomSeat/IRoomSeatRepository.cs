...
public interface IRoomSeatRepository : IRepository<RoomSeatEntity>
{
    ...
    Task<bool> IsDuplicatedRoomSeatByNameAndIdAsync(string name, long id, CancellationToken cancellationToken);
    Task<bool> IsDuplicatedRoomSeatByNameAsync(string name, CancellationToken cancellationToken);
}
