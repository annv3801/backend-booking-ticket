...
{
    Task<OffsetPaginationResponse<TheaterResponse>> GetListTheatersAsync(OffsetPaginationRequest request, CancellationToken cancellationToken);
    Task<TheaterResponse?> GetTheaterByIdAsync(long id, CancellationToken cancellationToken);
