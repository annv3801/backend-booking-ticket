...
public interface ITheaterRepository : IRepository<TheaterEntity>
{
    ...
    Task<OffsetPaginationResponse<TheaterResponse>> GetListTheatersFavoritesAsync(ViewTheaterFavoriteRequest request, long accountId, CancellationToken cancellationToken);
