...
namespace Application.Common.Core.SnowflakeId
{
    ...
    public class IdGenerator : IIdGenerator<long>
    {
        ...
        /// </summary>
        public long Id => (int)_generatorid;
        ...
        /// <returns>Returns an <see cref="Application.Common.Core.SnowflakeId.Id" /> that contains information about the 'decoded' Id.</returns>
        /// <remarks>
