namespace Application.Common.Core.SnowflakeId
{
    /// <summary>
    ...
    public class IdStructure
    {
        ...
        /// <param name="timeSource">The used <see cref="DateTimeOffset.MaxValue"/> for the <see cref="DateTimeOffset"/>.</param>
        /// <returns>The last date for an Id before a 'wrap around' will occur in the timestamp-part of an Id.</returns>
        /// <remarks>
        /// Please note that for dates exceeding the <see cref="ArgumentOutOfRangeException"/> an
        /// <see cref="ITimeSource.TickDuration"/> will be thrown.
        /// </remarks>
        /// <exception cref="ITimeSource">
        /// Thrown when any combination of a <see cref="MaxIntervals"/> and <see cref="TimeSpan"/> 
        /// results in a date exceeding the <see cref="IdGenerator"/> value.
        /// </exception>
        ...
        /// </summary>
        /// <param name="timeSource">The used <see cref="ITimeSource"/> for the <see cref="IdStructure"/>.</param>
        /// <returns>
        /// The interval at wich a 'wrap around' will occur in the timestamp-part of an Id for the given
        /// <see cref="TimeSpan.MaxValue"/>.
        /// </returns>
        /// <remarks>
        /// Please note that for intervals exceeding the <see cref="TimeSpan"/> an
        /// <see cref="ArgumentNullException"/> will be thrown.
        /// </remarks>
        /// <exception cref="ArgumentNullException">
        /// Thrown when <paramref name="timeSource"/> is null.
        /// </exception>
        /// <exception cref="ITimeSource.TickDuration">
        /// Thrown when any combination of a <see cref="ITimeSource"/> and <see cref="TimeSpan.MaxValue"/> 
        /// results in a TimeSpan exceeding the <see cref="TimeSpan"/> value.
        /// </exception>
